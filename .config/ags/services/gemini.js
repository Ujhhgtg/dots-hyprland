...
const HISTORY_DIR = `${GLib.get_user_state_dir()}/dots-hyprland/user/ai/chats/`;
...
Utils.exec(`mkdir -p ${GLib.get_user_state_dir()}/dots-hyprland/user/ai`);
const KEY_FILE_LOCATION = `${GLib.get_user_state_dir()}/dots-hyprland/user/ai/google_key.txt`;
const APIDOM_FILE_LOCATION = `${GLib.get_user_state_dir()}/dots-hyprland/user/ai/google_api_dom.txt`;
