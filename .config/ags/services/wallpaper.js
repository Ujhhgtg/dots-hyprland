...
const WALLPAPER_CONFIG_PATH = `${GLib.get_user_state_dir()}/dots-hyprland/user/wallpaper.json`;
...
class WallpaperService extends Service {
    ...
    constructor() {
        ...
        try {
            ...
            Utils.exec(`bash -c 'mkdir -p ${GLib.get_user_cache_dir()}/dots-hyprland/user'`);
