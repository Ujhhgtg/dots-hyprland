...
const scripts = [
	...
	},
    {
        ...
        command: `sudo ~/.local/bin/dots-hyprland/quickscripts/nixos-trim-generations.sh 5 0 system`,
        enabled: distroID == 'nixos',
    },
    {
        icon: 'nixos-symbolic',
        name: 'Trim home manager generations to 5',
        command: `~/.local/bin/dots-hyprland/quickscripts/nixos-trim-generations.sh 5 0 home-manager`,
        enabled: distroID == 'nixos',
    },
    {
